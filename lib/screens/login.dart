...
import 'package:tchowv1/screens/registration.dart';
...
//            CustomText(text: "Hey", size:100, color: yellow),

            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: <Widget>[
                Image.asset("images/tchow_logo.png", width: 120, height: 120,),
              ],
            ),
           ...
           Padding(
            ...
            GestureDetector(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: <Widget>[
                  CustomText(text: "Register here", size: 20, color: Colors.blueAccent,),
                ],
              ),
            ),
          ],
