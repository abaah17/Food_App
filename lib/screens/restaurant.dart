...
import 'package:tchowv1/models/restaurant.dart';
import 'package:tchowv1/providers/product.dart';
import 'package:tchowv1/screens/details.dart';
import 'package:tchowv1/widgets/custom_text.dart';
import 'package:tchowv1/widgets/loading.dart';
import 'package:tchowv1/widgets/product.dart';
import 'package:tchowv1/widgets/small_button.dart';
...
//              open & book section
              Row(
                ...
                children: <Widget>[
                  CustomText(text: "Available", color: green, weight: FontWeight.w400, size: 18,),
                  Container(
                      child: TextButton.icon(onPressed: (){}, icon: Icon(Icons.restaurant_menu), label: CustomText(text: "Order Now")))
                ],
              ),
