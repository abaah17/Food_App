  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0.0,
        centerTitle: true ,
        title: CustomText(text: "Shopping Cart", color: white,),
        leading: IconButton(
                        ...
                        children: <Widget>[
                          RichText(
                            text: TextSpan(children: [
                              ...
                              TextSpan(
                                  text: "\Rwf${user.userModel.cart[index].price } \n\n",
                                  style: TextStyle(
                                      color: black,
                                      fontSize: 18,
                ...
                text: TextSpan(children: [
                  TextSpan(
                      ...
                      style: TextStyle(
                          ...
                          fontWeight: FontWeight.w400)),
                  TextSpan(
                      text: " \Rwf${user.userModel.totalCartPrice }",
                      style: TextStyle(
                          color: primary,
                          fontSize: 22,
                              ...
                              child: Container(
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      Text('You will be charged \Rwf${user.userModel.totalCartPrice } upon delivery!', textAlign: TextAlign.center,),
                                      ...
                                      SizedBox(
                                        ...
                                        child: ElevatedButton(
                                          ...
                                          child: CustomText(text:"Accept", color: white, size:25, weight: FontWeight.w600,),
//                                          Text("Accept",style: TextStyle(color: Colors.white),),

                                          //color change necessary
                                      ...
                                      SizedBox(
                                        ...
                                        child:  ElevatedButton (
                                          ...
                                          child:CustomText(text:"Reject", color: white, size:25, weight: FontWeight.w600,),
